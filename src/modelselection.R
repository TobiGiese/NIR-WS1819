...
# plot first deviation for first 6 records
plot(x, getDiff(t(nirs_filtered.data)[,1], 318), type='l', col=1)
lines(x, getDiff(t(nirs_filtered.data)[,2], 318), type='l', col=2)
lines(x, getDiff(t(nirs_filtered.data)[,3], 318), type='l', col=3)
lines(x, getDiff(t(nirs_filtered.data)[,4], 318), type='l', col=4)
lines(x, getDiff(t(nirs_filtered.data)[,5], 318), type='l', col=5)
lines(x, getDiff(t(nirs_filtered.data)[,6], 318), type='l', col=6)
